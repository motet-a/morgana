...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toConsumableArray2 = __webpack_require__(48);
	...
	var dependencies = new _map2.default();
	var naming = new _map2.default();
	var singletons = new _map2.default();
	...
	var Container = exports.Container = function () {
	  ...
	  (0, _createClass3.default)(Container, null, [{
	    key: 'resolve',
	    value: function resolve(classReference) {
	    ...
	    value: function resolveSingleton(classReference) {
	    ...
	    value: function resolveSingleInstance(ClassReference) {
	      return new (Function.prototype.bind.apply(ClassReference, [null].concat((0, _toConsumableArray3.default)(Container.resolveAll.apply(Container, (0, _toConsumableArray3.default)(dependencies.get(ClassReference) || []))))))();
	    }
	  }, {
	    key: 'normalize',
	    value: function normalize(classReference) {
	    ...
	    key: 'registerAsDependencies',
	    value: function registerAsDependencies(classReference, deps) {
	      dependencies.set(classReference, deps);
	    }
	  }, {
	    key: 'registerAsSingleton',
	    value: function registerAsSingleton(classReference) {
	      if (!singletons.has(classReference)) {
	    ...
	    key: 'registerName',
	    value: function registerName(classReference, className) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _injectable = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function inject() {
	  ...
	  return function (classReference) {
	    return _container.Container.registerAsDependencies(classReference, args);
	  };
	}
	...
	function naming() {
	  ...
	  return function (classReference) {
	    return !args.length ? _container.Container.registerName(classReference, classReference.name) : _container.Container.registerName(classReference, args.shift());
	  };
	}

	function singleton() {
	  return function (classReference) {
	    return _container.Container.registerAsSingleton(classReference);
	  };
	}

	function $(classReference) {
	  return _container.Container.resolve(classReference);
	}
